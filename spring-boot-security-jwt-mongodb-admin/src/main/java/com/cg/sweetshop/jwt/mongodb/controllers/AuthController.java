...
import com.cg.sweetshop.jwt.mongodb.payload.response.JwtResponse;
import com.cg.sweetshop.jwt.mongodb.payload.response.MessageResponse;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByName(ERole.ROLE_UNDEFINED)
